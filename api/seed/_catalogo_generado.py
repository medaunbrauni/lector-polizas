...
COMPANIAS_CON_PRIORIDAD = [
    ...
    # P29: Quálitas Salud (0.05%)
    {
        ...
        "ramos": [
            ...
            {
                "nombre": 'Producción Asociada',
                "keywords": ['producción asociada', 'produccion asociada'],
                "subramos": [
                    {"nombre": 'Produccion Asociada', "keywords": ['producción asociada'], "prioridad": 176, "porcentaje_docs": 8.6e-05},
                ],
            },
        ],
    },
